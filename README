...
pandas:
youtube: https://www.youtube.com/watch?v=2uvysYbKdjM&t=12s
pandas documentation: https://pandas.pydata.org/docs/
dataset kaggle: https://www.kaggle.com/datasets/rajugc/imdb-top-250-movies-dataset?resource=download
